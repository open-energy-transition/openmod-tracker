...
class TestGetScores:
    ...
    @pytest.mark.parametrize("token_name,token_value,expected_result", [
    ...
    def test_github_url_with_any_github_token(self, token_name: str, token_value: str, expected_result: bool) -> None:
    ...
    @pytest.mark.parametrize("token_name,token_value,expected_result", [
        ("GH_TOKEN", "test_token", False),
        ("GITLAB_AUTH_TOKEN", "test_token", True),
    ])
    def test_gitlab_url_with_gitlab_token(self, token_name: str, token_value: str, expected_result: bool) -> None:
